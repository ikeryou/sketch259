...
export class Contents extends MyDisplay {
  ...
  constructor(opt:any) {
    ...
    particleOptions = Common.extend({ inertia: Infinity, friction: 0.99, collisionFilter: { group: group }, render: { visible: false }}, particleOptions);
    ...
    const areaW = sw * Func.instance.val(0.8, 0.35);
    const areaH = areaW;
    ...
    this._mouse = Bodies.rectangle(0, 0, mouseSize, mouseSize, {isStatic:true, render:{visible:false}});
    Composite.add(this.engine.world, [
      this._mouse,
    ]);
